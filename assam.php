...
?>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class=" text-dark">Dashboard-Assam</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-info elevation-5">
                            <?php
                            $data = file_get_contents('http://172.17.87.229/6senses/admin_get_state_wise_data.php?STATE=Assam');
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success elevation-5">
                            <?php
                            $datas = file_get_contents('http://172.17.87.229/6senses/admin_get_state_wise_data.php?STATE=Assam');
    ...
    <script>
        ...
        async function getData() {
            const response = await fetch('http://172.17.87.229/6senses/admin_get_state_wise_data.php?STATE=Assam');
